...
class CLI:
    ...
    def LoggedInMenu(self):
        ...
        Name = self.Database.GetName(self.CurrentUserID)
    ...
    def DrawChangeValueMenu(self, UserAttribute):
        ...
        if UserAttribute == self.Database.UserAttribute.Email:
            ...
            print(f"Your current email is {self.Database.GetEmailAddress(self.CurrentUserID)}")
            print()
            ...
            print(f"Your current name is {self.Database.GetName(self.CurrentUserID)}")
            print()
            ...
            OldPhoneNumber = f"({self.Database.GetPhoneNumber(self.CurrentUserID)[:3]}) {self.Database.GetPhoneNumber(self.CurrentUserID)[3:6]}-{self.Database.GetPhoneNumber(self.CurrentUserID)[6:]}"
